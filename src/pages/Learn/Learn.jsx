    ...
    return (
        <>
            <div className={styles.learnContainer}>
                ...
                <div className={styles.marginTop}>
                    <div className='gx-0 row' style={{ width: "100%" }}>
                        ...
                        <div className='col-lg-4 order-sm-first order-last'>
                            <img src={learn2} alt="" className={styles.learnImg2} />
                        </div>
                ...
                <div className={styles.marginTop}>
                    <div className='gx-0 row' style={{ width: "100%", marginLeft: 'auto', marginRight: 'auto' }}>
                        ...
                        <div className='col-lg-5'>
                            <img src={learn3} alt="" className={styles.learnImg3} />
                        </div>
                ...
                <div >
                    <div className='gx-0 row' style={{ width: "100%", marginLeft: 'auto', marginRight: 'auto' }} >
                        <div className='col-lg-4 order-sm-first order-last'>
                            <img src={learn4} alt="" className={styles.learnImg4} />
                        </div>
                        <div className='col-lg-8'>
                            <div className={styles.aboutContent}>
                                <h4>DefInvestment</h4>
                ...
                {/* <div className={styles.decentralizedSection}>
                    <div className='gx-0 row' style={{ width: "100%", marginLeft: 'auto', marginRight: 'auto' }}>
                ...
                <div className={styles.marginTop}>
                    <div className='gx-0 row' style={{ width: "100%" }}>
                        ...
                        <div className='col-lg-4'>
                            <img src={learn5} alt="" className={styles.learnImg4} />
                        </div>
                ...
                <div className={styles.marginTop}>
                    <div className='gx-0 row' style={{ width: "100%" }}>
                        ...
                        <div className='col-lg-4'>
                            <img src={learn7} alt="" className={styles.learnImg6} />
                        </div>
